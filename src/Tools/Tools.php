...
class Tools
{
    ...
    static public function telemedicina_indicador_1()
    {
        $patients = Manager::connection("db_telemedicina")
            ->select(Manager::raw("ca.idcupanexo3, v.fechainicio, ca.fecha, a.numerosolicitud, a.idprioridadatencion, a.enviado as sol_enviada, ca.idestadocupanexo3, ca.idusuario, ca.fechadireccionamiento,
