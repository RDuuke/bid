...
class Tools
{
    ...
    static public function telemedicina_indicador_1()
    {
        ...
        $q = $pdo->prepare("Select ca.idcupanexo3, v.fechainicio, ca.fechacreacion, a.numerosolicitud, a.idprioridadatencion, a.enviado as sol_enviada, ca.idestadocupanexo3, ca.idusuariodireccionador, 
        ca.fechadireccionamiento, ca.idusuariodevolucion, ca.fechadevolucion, ti.descripcion as tipo_documento, p2.numerodocumento, p2.nombre1, p2.nombre2, p2.apellido1, p2.apellido2, p2.fechanacimiento, p2.sexo,
        p2.raza, p2.idcoberturasalud, eps.nombre as eps, regexp_replace(nc.subjetivo, E'[\\n\\r]+', ' ', 'g' ) as subjetivo, regexp_replace(nc.objetivo, E'[\\n\\r]+', ' ', 'g' ) as objetivo,
